...
function applyFilters() {
    ...
    const category = document.querySelector('input[name="sort2"]:checked')?.value || 'none';
...
function resetCategory() {
    document.querySelector('input[name="sort2"][value="none"]').checked = true;
    applyFilters();
}
...
function resetFilters() {
    ...
    const url = `?page=1&sort=none&min_price=0&max_price=1000&category=none`;
