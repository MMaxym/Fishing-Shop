    ...
    <div class="container">
        ...
        <section class="about-details">
            <div class="about-block">
                ...
                <p class="about-text">
                    Наш магазин пропонує інноваційні та надійні рибальські принади, розроблені спеціально для водойм України.
                </p>
            </div>
            <div class="about-block">
                <h2 class="about-heading">📦 Широкий асортимент</h2>
                <p class="about-text">
                    В «Fishing Shop» ви знайдете широкий вибір сучасних приладь: від силіконових принад до балансирів і тейл-спінерів.
                </p>
            </div>
            <div class="about-block">
