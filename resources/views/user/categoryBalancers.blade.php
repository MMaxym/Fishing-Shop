...
<head>
    <link rel="stylesheet" href="{{ asset('css/user/categoryBalancers.css') }}">
...
@section('content')
    ...
    <main class="main-section">
            ...
            <div class="main-row-wrapper">
                <nav aria-label="breadcrumb" class="page-navigation">
                    <ul class="breadcrumb-list">
                        ...
                        <li class="current-product">Балансири</li>
                    </ul>
                </nav>
            </div>
        </section>
        <section class="main-row">
            <div class="products-wrapper">
                <h2 class="row-title" id="main-title">Балансири</h2>
    ...
    <script src="{{ asset('js/user/categoryBalancers.js') }}"></script>
