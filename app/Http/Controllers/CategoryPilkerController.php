...
class CategoryPilkerController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('user.categoryPilkers', compact('products', 'currentPage', 'perPage', 'totalItems', 'itemsShown'));
    }
...
//        $itemsShown = ($currentPage - 1) * $perPage + $products->count();
//
//        return view('user.categoryPilkers', compact('products', 'currentPage', 'perPage', 'totalItems', 'itemsShown', 'sortOrder', 'minPrice', 'maxPrice'));
//    }
//
//
